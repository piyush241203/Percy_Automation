...
test.describe('Evantech Core Pages - Visual Snapshots', () => {
  ...
  test('Home Page - Visual Validation @home', async ({ page }) => {
    await page.goto('/');
  ...
  test('Login Page - Visual Validation @login', async ({ page }) => {
  ...
  test('Signup Page - Visual Validation @signup', async ({ page }) => {
  ...
  test('Dashboard Page - Visual Validation @dashboard', async ({ page }) => {
  ...
  test('Payment Page - Visual Validation @payment', async ({ page }) => {
  ...
  test('Checkout Page - Visual Validation @checkout', async ({ page }) => {
  ...
  test('Profile Page - Visual Validation @profile', async ({ page }) => {
